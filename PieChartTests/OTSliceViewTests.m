...
- (void)testSortSliceLayerListBySliceAngle_With_OneObject
{
    ...
    STAssertTrue([result objectAtIndex:0] == self.slice1,nil);
}
...
- (void)testSortSliceLayerListBySliceAngle_With_TwoObjects
{
    ...
    STAssertTrue([result objectAtIndex:0] == self.slice1, nil);
    STAssertTrue([result objectAtIndex:1] == self.slice2, nil);
}
...
- (void)testSortSliceLayerListBySliceAngleWithGoodData1
{
    ...
    STAssertTrue([result objectAtIndex:0] == self.slice1, nil);
    STAssertTrue([result objectAtIndex:1] == self.slice2, nil);
    STAssertTrue([result objectAtIndex:2] == self.conflictSliceWith4, nil);
...
- (void)testCompareByAngleWithNil
{
    ...
    STAssertEquals(result, NSOrderedDescending, nil);
}
...
- (void)testCompareByAngleWith10and20
{
    ...
    STAssertEquals(result, NSOrderedAscending, nil);
}
...
- (void)testCompareByAngleWith10and10
{
    ...
    STAssertEquals(result, NSOrderedSame, nil);
}
